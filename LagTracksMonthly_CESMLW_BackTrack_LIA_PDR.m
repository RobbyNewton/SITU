...
%                             disp('Safe!')
        ...
        %% Save data
        save(['Data_BackTrack_LIA_CESMLW_' member{imem} '_' int2str(syear) '-' ...
            sprintf('%02d',smonth) 'to' int2str(eyear) '-' sprintf('%02d',emonth) '.mat'],...
            'XLag','YLag')

        movefile(['Data_BackTrack_LIA_CESMLW_' member{imem} '_' int2str(syear) '-' ...
            sprintf('%02d',smonth) 'to' int2str(eyear) '-' sprintf('%02d',emonth) '.mat'],...
            CESMLWLIAMPath)
