%  LagTracksMonthly_CESMLE_ForwardTrack_OilSpillN
%
%  A scrip to:
...
%                             disp('Safe!')
        ...
        %% Save data
        save(['Data_ForwardTrack_OilSpillN_CESMLE_' member{imem} '_' int2str(syear) '-' ...
            sprintf('%02d',smonth) 'toMelt.mat'],'XLag','YLag')
        clear XLag YLag

        movefile(['Data_ForwardTrack_OilSpillN_CESMLE_' member{imem} '_' int2str(syear) '-' ...
            sprintf('%02d',smonth) 'toMelt.mat'],CESMLELIAMPath)
